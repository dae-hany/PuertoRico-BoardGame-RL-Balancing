...
def train(exp_name: str = "", potential_type: str = "base"):
    ...
    base_name = "NoShapingPPO_PR_Server"
    ...
    try:
        for update in range(1, total_updates + 1):
            ...
            writer.add_scalar("Hyperparameters/Shaping_Weight", 0.0, global_step)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--potential_type", type=str, default="none", choices=["base", "vp_only", "economic", "none"], help="Type of potential function for shaping")
